...
public class AmazonSNSClientWrapper {
	...
	public void notification(Platform platform, String principal,
	...
	private String getPlatformSampleMessage(Platform platform) {
		...
		case APNS_SANDBOX:
			return MessageGenerator.getSampleAppleMessage();
		case GCM:
			return MessageGenerator.getSampleAndroidMessage();
		case ADM:
			return MessageGenerator.getSampleKindleMessage();
		case BAIDU:
			return MessageGenerator.getSampleBaiduMessage();
		case WNS:
			return MessageGenerator.getSampleWNSMessage();
		case MPNS:
			return MessageGenerator.getSampleMPNSMessage();
		default:
	...
	public static Map<String, MessageAttributeValue> getValidNotificationAttributes(
		...
		for (Map.Entry<String, MessageAttributeValue> entry : notificationAttributes
				.entrySet()) {
			if (!StringUtil.isEmptyIgnoreBlank(entry.getValue().getStringValue())) {
